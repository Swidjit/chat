class PhrasesController < ApplicationController
  ...
  def check_validity2
    ...
    if !Blacklist.is_blacklisted(str)
      ...
      respond_to do |format|
        format.json { render :json => {:success => :false, :mode => mode, :changes=>changes} }
      end
    end
